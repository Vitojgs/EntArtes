...
## Apêndice: Novos Endpoints (adicionados em 2026-05-06/09)

Os seguintes endpoints foram implementados recentemente e não constam na matriz original:
...
| Método | Path | Role Guard | Controller |
|--------|------|-----------|------------|
| `GET` | `/api/salas/consultar-sala-disponivel` | auth only | `consultarSalaDisponivel()` |

### Autenticação

| Método | Path | Role Guard | Controller |
|--------|------|-----------|------------|
| middleware | — | — | `role.middleware.js` — `authorizeRole(...roles)` |

### Contacto

| Método | Path | Role Guard | Controller |
|--------|------|-----------|------------|
| `POST` | `/api/public/contacto` | público | Email via nodemailer (sem BD) |
...
*Documento gerado a 2026-05-08 como parte da auditoria comprehensive do sistema Ent'Artes. Atualizado a 2026-05-10 com novos endpoints.*
