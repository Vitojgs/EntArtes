...
import { mockAnuncios, mockReservasFigurino, mockFigurinos } from '../data/mockData';
...
export function Marketplace() {
  const { user } = useAuth();
  const [anuncios, setAnuncios] = useState<AnuncioMarketplace[]>(mockAnuncios);
  const [reservas, setReservas] = useState<ReservaFigurino[]>(mockReservasFigurino);
