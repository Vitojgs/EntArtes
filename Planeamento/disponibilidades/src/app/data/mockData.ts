import {
  ...
  Evento, Estudio, SlotDisponibilidade, Turma, ProfessorPerfil
} from '../types';
...
export const mockProfessoresPerfis: ProfessorPerfil[] = [
  {
    professorId: 'prof1',
    bio: 'João Santos é coreógrafo e professor de dança urbana com mais de 12 anos de experiência. Formado pela escola de dança contemporânea de Lisboa, especializou-se em Hip-Hop e estilos urbanos após formação internacional em Nova Iorque e Paris. É reconhecido pela sua energia contagiante em sala de aula e pela capacidade de motivar alunos de todos os níveis.',
    especialidades: ['Hip-Hop', 'Dança Urbana', 'Breaking', 'Popping & Locking'],
    anosExperiencia: 12,
    formacao: 'Escola de Dança Contemporânea de Lisboa · Formação Internacional NYC & Paris'
  },
  {
    professorId: 'prof2',
    bio: 'Ana Costa é bailarina clássica e professora com mais de 15 anos de carreira artística. Formada pelo Conservatório Nacional de Dança, integrou companhias de ballet em Portugal e Espanha antes de se dedicar ao ensino. A sua abordagem pedagógica alia rigor técnico à expressividade artística, preparando alunos para avaliações técnicas e espetáculos profissionais.',
    especialidades: ['Ballet Clássico', 'Ballet Contemporâneo', 'Dança Clássica', 'Técnica Vaganova'],
    anosExperiencia: 15,
    formacao: 'Conservatório Nacional de Dança · Companhia Nacional de Ballet'
  },
  {
    professorId: 'prof3',
    bio: 'Carlos Mendes é artista multidisciplinar com formação em dança contemporânea, teatro e artes performativas. Licenciado em Artes Performativas pela Universidade de Évora, desenvolveu a sua carreira em Portugal e no Brasil, colaborando com diversas companhias de dança contemporânea. A sua metodologia incentiva a criatividade, improvisação e exploração do movimento como linguagem expressiva.',
    especialidades: ['Dança Contemporânea', 'Teatro Dança', 'Improvisação', 'Composição Coreográfica'],
    anosExperiencia: 10,
    formacao: 'Licenciatura em Artes Performativas — Universidade de Évora · Residências artísticas em São Paulo'
  }
];