...
> **Actualizado em 2026-05-11.**
> Dados actuais: **30 ficheiros Vitest (447 testes, 100%)** + **96 assertions Postman (81%)** + **24 testes E2E configurados (não executáveis no ambiente actual).**
> Para o resumo executivo, consultar [`QUADROS_RESUMO_TESTES.md`](./QUADROS_RESUMO_TESTES.md).
...
```
        ╱╲
       ╱ E2E ╲           ← Playwright (24 testes — ⚠️ não executável)
      ╱────────╲
     ╱ Integração ╲       ← Vitest + BD real (66 testes)
    ╱──────────────╲
   ╱     API         ╲    ← Vitest + app.inject() (39 testes)
  ╱────────────────────╲
 ╱   Unitários          ╲ ← Vitest + Mocks (302 testes)
╱──────────────────────────╲
╱ Contract + Edge            ╲ ← Vitest (40 testes)
╱──────────────────────────────╲
╱   Postman/Newman               ╲ ← Testes de API (96 assertions, 78 ✅)
╱──────────────────────────────────╲
```
